...
#define STMR0_PERIOD_VAL (SYSCLK / (STRM0_PSC_VAL_CONFIG + 1) / 200) // 目前值：30000
#define STMR0_PERIOD_30_PERCENT_VAL ((u32)STMR0_PERIOD_VAL * 30 / 100)
...
#define STMR1_PERIOD_30_PERCENT_VAL ((u32)STMR1_PERIOD_VAL * 30 / 100)
...
/*
    ((u16)((u32)((48000000UL) / ((8 - 1) + 1) / 200) * 100 - 70 / 100))
*/
